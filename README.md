...
Unit inspector、unit tooltip 和 SpriteKit region / objective 摘要现在也按拿战显示上下文净化可见 formation 名、allegiance 名、目标控制状态、component type code、contact line 与 composition 空态；这些只改变 display text，不改 `Division`、`Faction`、`ComponentType`、`GameState` 或规则层数据。
