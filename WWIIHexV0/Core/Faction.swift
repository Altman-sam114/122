...
enum NapoleonicMessageSanitizer {
    ...
    private static let replacements: [(String, String)] = [
        ...
        ("TheaterDirective JSON", "staff record"),
        ("Compiled ZoneDirective JSON", "compiled corps orders audit"),
        ("ZoneDirective", "corps order"),
        ("zoneDirective", "corps order"),
        ("StrategicPosture JSON", "campaign posture audit"),
        ("Guderian", "Staff Commander"),
        ("targetDivisionId", "target formation"),
        ("divisionId", "formation"),
        ("targetRegionIds", "target sectors"),
        ("fallbackRegionIds", "fallback sectors"),
        ("targetTheaterId", "target wing"),
        ("preferredFrontZoneId", "preferred corps sector"),
        ("commanderAgentId", "command staff"),
        ("targetTemplateIds", "target reserve types"),
        ("templateId", "reserve type"),
        ("objectiveIds", "objectives"),
        ("objectiveId", "objective"),
        ("triggerObjectiveId", "arrival objective"),
        ("toRegionId", "target sector"),
        ("regionId", "sector"),
        ("theaterId", "wing"),
        ("frontZoneId", "corps sector"),
        ("zoneId", "corps sector"),
        ("frontZone", "corps sector"),
        ("front zones", "corps sectors"),
        ("front zone", "corps sector"),
        ("rawValue", "display code"),
        ("agentId", "staff officer"),
        ("issuerId", "issuing staff"),
        ("command directives", "corps orders"),
        ("command directive", "corps order"),
