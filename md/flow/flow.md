...
- `TacticConditionChecker` 已对机动、骑兵、炮兵/远程、佯攻和纵深防御做最小条件过滤；v3.11 已把 infantry-heavy + hold 接成 square-ready hold 的最小防骑兵克制，v3.12-v3.14 让 AI / Marshal 摘要读取可见敌方骑兵压力、更偏向 Hold Line，并在 staff rationale / priority / Situation 摘要中暴露该压力；v3.15 让玩家在 Command panel、Corps Command brief 和首次 infantry-heavy formation guide note 中提前看到 square-ready Hold 口径，但完整队形、方阵克制、炮兵准备/骑兵冲锋的发布级平衡仍未完成。
