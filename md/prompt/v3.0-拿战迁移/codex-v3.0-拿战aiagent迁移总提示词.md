...
- EventLog 分类展示已覆盖 Engagement / Withdrawal / Logistics / Dispatch，仍只在 Standard / Concise 层做展示净化，Full raw 审计值保留。
